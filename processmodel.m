function processmodel(pm)
    ...
    includeAnalyzeModelCode = false && ~padv.internal.util.isMACA64 && exist('polyspaceroot','file');
    includeProveCodeQuality = false && ~padv.internal.util.isMACA64 && (~isempty(ver('pscodeprover')) || ~isempty(ver('pscodeproverserver')));
