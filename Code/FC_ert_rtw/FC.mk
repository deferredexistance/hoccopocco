###########################################################################
## Makefile generated for component 'FC'. 
## 
## Makefile     : FC.mk
## Generated on : Wed Apr 08 10:40:17 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\FC.exe
...
START_DIR                 = C:\Work_Local\Bosch\CIDemo\RootFolder\FC\Code
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = FC_comp.rsp
CMD_FILE                  = FC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FC.exe
...
DEFINES_STANDARD = -DMODEL=FC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\FC_ert_rtw\FC.c

MAIN_SRC = $(START_DIR)\FC_ert_rtw\ert_main.c
...
{$(START_DIR)\FC_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FC_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FC_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FC_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
FC.obj : "$(START_DIR)\FC_ert_rtw\FC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FC_ert_rtw\FC.c"


ert_main.obj : "$(START_DIR)\FC_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FC_ert_rtw\ert_main.c"
